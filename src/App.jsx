  ...
  return (
    <div className="space-y-6 pb-8 relative">
      ...
      <div className="space-y-4">
        ...
        {viewMode === 'today' && (
          <div className="glass-card p-2 rounded-[2rem] flex justify-between border border-white/10">
            {[
          ...
          <>
            {filteredHabits.map((habit) => {
              ...
              return (
                <div
                  key={habit.id}
                  className={`glass-card p-5 rounded-[2rem] relative overflow-hidden ${isCompleted ? 'opacity-80' : ''}`}
                >
